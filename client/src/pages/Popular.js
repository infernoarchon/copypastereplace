        ...
        <div className="story-wrapper card mb-3">
          ...
          <div className="row p-0">
            <div className="col-12 col-md-2 p-0">
              <div className="gif-feed"><NavLink to={"/story/" + story._id}><img src={story.gif_s} /></NavLink></div>
            ...
            <div className="story-desc col-12 col-md-10">
              ...
              <p className="story-summary">{story.content.slice(0,200) + "..."}</p>
            </div>
          </div>
