    ...
    return(
      ...
      <Row>
        ...
        <div className="story-wrapper card mb-3">
          ...
          <NavLink to={"/story/" + story._id}><h1 id={story._id} onClick={this.incrementView}>{story.title}</h1></NavLink>          <p className="author-attr">created {moment(story.date).fromNow()} by {story.author}</p>
